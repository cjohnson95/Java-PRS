...
public class RequestsController {
	...
	public ResponseEntity<Iterable<Request>> GetOrderNotUser(@PathVariable int userId) {
	...
	public ResponseEntity SetOrderTo50(@PathVariable int id, @RequestBody Request request) {
		request.setTotal(50);
		return Update(id, request);
	}
	
	@PutMapping("reject/{id}")
	public ResponseEntity SetOrderToNegative1(@PathVariable int id, @RequestBody Request request) {
		request.setTotal(-1);
		return Update(id, request);
	}
